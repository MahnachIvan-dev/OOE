...
<link rel="icon" href="https://cdn.jsdelivr.net/gh/MahnachIvan-dev/-ooe-image@main/Ug7gX.jpg" type="image/x-icon">
...
<div id="appScreen" class="hidden">
  ...
  <footer class="footer">
    <div class="footer-grid">
      <div>
        <h4>О портале</h4>
        <p>ООИ — Организация Объединённых Империй. Сообщество цифровых империй, государств и организаций.</p>
      </div>
      <div>
        <h4>Навигация</h4>
    ...
    <div class="footer-bottom">ООИ — Организация Объединённых Империй</div>
  </footer>
</div>
...
const App = {
  ...
  renderHome(c) {
    ...
    // Лента активности
    const activities = (this.data.activities || []).slice(0, 5);
    let activityHtml = '';
      ...
      activityHtml = `
        <section style="padding:40px 0;">
          ...
          <div class="activity-feed">
            ${activities.map(a => {
              const icons = { join: 'user-plus', post: 'comment', news: 'newspaper', empire: 'crown', alliance: 'handshake' };
              return `
                <div class="activity-item">
                  <div class="activity-icon ${a.type || 'post'}"><i class="fas fa-${icons[a.type] || 'circle'}"></i></div>
                  <div class="activity-text">${a.text || 'Событие'}</div>
  ...
  requestVerify(chId) {
    ...
    const communityLink = (this.data.settings && this.data.settings.communityLink) || 'https://invite.viber.com/?g2=AQBBsxqy%2FrDlOlbPL5C9RdiOVtPeFKkPjeCMSpbg4GY2H2eX5Lcp%2FbTzZu62vYra';
